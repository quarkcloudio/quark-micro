...
func (p *kCombineServiceClient) ResourceHandle(ctx context.Context, req *admin.ResourceRequest, callOptions ...callopt.Option) (r *admin.ResourceResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ResourceHandle(ctx, req)
}

func (p *kCombineServiceClient) CaptchaHandle(ctx context.Context, req *admin.ResourceRequest, callOptions ...callopt.Option) (r *admin.ResourceResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
